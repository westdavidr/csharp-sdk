...
/// of the Model Context Protocol (MCP) server. This builder is returned by an
/// AddMcpServer extension method and provides access to the service collection for registering additional MCP components.
/// </summary>
